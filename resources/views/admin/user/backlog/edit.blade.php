...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12">
      <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
        ...
        <a class="btn btn-success btn-sm" href="{{ route('admin.'.request()->segment(2).'.show',$user) }}">Back</a>           
       </div>
    </div>
</div>
</div>
...
<div class="card">
    <div class="card-content">
          ...
          <div class="card-body">
            <span class="card-title pull-left" style="text-transform: capitalize;"><b>Name:</b> {{$backlog->user->name}}</span>
            <span class="card-title pull-right" style="text-transform: lowercase;"><b style="text-transform: capitalize;">Email:</b>{{$backlog->user->email}}</span>
