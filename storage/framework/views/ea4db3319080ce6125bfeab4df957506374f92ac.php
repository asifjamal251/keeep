...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12">
      <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
        ...
        <a class="btn btn-success btn-sm" href="<?php echo e(route('admin.'.request()->segment(2).'.show',$user)); ?>">Back</a>           
       </div>
    </div>
</div>
</div>
                ...
                <div class="col-lg-6 col-6">
                    ...
                    <div class="card text-white bg-danger">
                        ...
                        <div class="form-group <?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo Form::file('image', ['id'=>'backlog_img','class'=>'dropify','data-default-file'=>asset($backlog->image)]); ?>
                        ...
                        <a id="dd" href="<?php echo e(asset($backlog->image)); ?>" class="btn btn-danger btn-darken-3" download>Download Image</a>
                        ...
                        <div class="card-content">
                         ...
                         <div class="form-group <?php echo e($errors->has('image_keey') ? ' has-error' : ''); ?>">
                            <?php if(@$keep->image != ''): ?>
                             ...
                             <?php else: ?>
                             <?php echo Form::file('image_keep', ['id'=>'keep_img','class'=>'dropify']); ?>

                             <?php endif; ?>

                                <small class="text-danger"><?php echo e($errors->first('image_keep')); ?></small>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/user/backlog/edit.blade.php ENDPATH**/ ?>