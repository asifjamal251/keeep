        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="stack admin logo" src="<?php echo e(asset('admin-assets/app-assets/images/logo/stack-logo-light.png')); ?>">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="<?php echo e(asset('admin-assets/app-assets/images/slider/slider-2.png')); ?>"
                ...
                <li class="scrollable-container media-list">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-1.png')); ?>" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-2.png')); ?>" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-3.png')); ?>" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-6.png')); ?>" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="avatar avatar-online">
                  <img src="<?php echo e(Auth::guard('admin')->user()->avatar??asset('admin-assets/app-assets/images/portrait/small/avatar-s-1.png')); ?>" alt="avatar"><i></i></span>
...
</nav><?php /**PATH D:\laravel\react\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>