      ...
      <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
        <div class="btn-group" role="group">
            <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                <?php echo Form::select('status', [1=>'Processed',0=>'Unprocess',2=>'Assign'], null, ['id' => 'status', 'class' => 'form-control', 'placeholder' => 'Select Status','onChange'=>'status(this)']); ?>
...
var selectedRows = new Array
  ...
  //alert('hello');  
            ...
            var table2 = $('#dataTableAjax').DataTable({
                ...
                "serverSide": true,
                'ajax': {
                    'url': '<?php echo e(route('admin.backlog.index')); ?>',
                    'data': function(d) {
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                ...
                                if( row['changeStatus']=='0' || row['changeStatus']=='4'){
                                    btn+='<button type="button" onclick="updateData(\'<?php echo e(route('admin.keep.changeStatus')); ?>\',{id:'+row['id']+',status:4})" class="btn btn-social-icon btn-outline-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Reassign"><i class="ft-corner-right-up"></i></button> ';

                                    btn+='<button type="button" onclick="updateData(\'<?php echo e(route('admin.keep.changeStatus')); ?>\',{id:'+row['id']+',status:1})" class="btn btn-social-icon btn-outline-success btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Approve"><i class="ft-check-square"></i></button> ';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/user-image/list.blade.php ENDPATH**/ ?>