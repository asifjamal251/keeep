...
<script type="text/javascript">
  ...
  //alert('hello');  
            ...
            var table2 = $('#dataTableAjax').DataTable({
                ...
                "serverSide": true,
                'ajax': {
                    'url': '<?php echo e(route('admin.image.index')); ?>',
                    'data': function(d) {
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                ...
                                console.log(row['statusKeep'])
                                 <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_image')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/image/list.blade.php ENDPATH**/ ?>