...
<div class="card">
    <div class="card-content">
        <div class="card-body">
           <?php echo Form::open(['route'=>['admin.myprofile.update',$admin->id],'method'=>'put','files'=>true]); ?>
           ...
           <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group<?php echo e($errors->has('avatar') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::file('avatar', ['class' => 'dropify','data-default-file'=>$admin->avatar?asset($admin->avatar):'']); ?>

                            <?php echo Form::hidden('checkfile',asset($admin->avatar)??'', ['id' => 'checkfile']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/admin/profile/edit.blade.php ENDPATH**/ ?>