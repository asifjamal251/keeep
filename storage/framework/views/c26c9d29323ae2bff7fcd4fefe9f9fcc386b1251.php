  ...
  <div class="app-content content login-main">
    <div class="content-wrapper login-div">
      ...
      <div class="content-body">
        ...
        <section class="col-md-3 col-8 m-auto box-shadow-2 <?php if(isset($errors)&&count($errors) > 0): ?> animated shake <?php endif; ?>">
...
</html><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>