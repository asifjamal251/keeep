...
<script type="text/javascript">
  ...
  //alert('hello');  
            ...
            var table2 = $('#dataTableAjax').DataTable({
                ...
                "serverSide": true,
                'ajax': {
                    'url': '<?php echo e(route('admin.backlog.index',$user)); ?>',
                    'data': function(d) {
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                var btn = '';
                                    ...
                                    btn += '<button type="button" onclick="deleteAjax(\'/admin/backlog/'+row['id']+'\')" class="btn btn-xs btn-social-icon btn-outline-danger"><i class="fa fa-trash"></i></button>&nbsp;';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sanix\ios\resources\views/admin/user/backlog/list.blade.php ENDPATH**/ ?>