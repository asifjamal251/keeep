                    ...
                    { "data": "created_at" }, 
                    {
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_test')): ?>
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_test')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanixu9b/public_html/app/resources/views/admin/user/list.blade.php ENDPATH**/ ?>