...
u + .body .full { width:100% !important; width:100vw !important;}
  ...
  <table data-module="noti-2" class="full" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody><tr>
      <td data-bgcolor="Main BG" data-background="Main BG" background="<?php echo e(asset('images/bg.jpg')); ?>" bgcolor="#494c50" valign="top" style="background-size: cover; background-position: center center; background-image: url(&quot;<?php echo e(asset('images/bg.jpg')); ?>&quot;); background-color: rgb(25, 45, 235);">
          ...
          <tr>
            <td data-bgcolor="Panel" bgcolor="#FFFFFF" style="border-top-left-radius: 4px;border-top-right-radius: 4px;" align="center">
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!-- logo -->
                <tr>
                  <td align="center" style="line-height: 0px;"><img mc:edit="noti-2-1" src="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('logo'))); ?>" alt="<?php echo e(App\Model\SiteSetting::latest()->value('site_title')); ?>" height="60" style="display:block; line-height:0px; font-size:0px; border:0px;" editable="" label="logo"></td>
                </tr>
                <!-- end logo -->
                <tr>
                  <td height="15"></td>
                    ...
                    <table class="textbutton" align="center" border="0" cellspacing="0" cellpadding="0">
                      <tbody><tr>
                        <td mc:edit="noti-2-5" data-bgcolor="Button Color" data-size="Button" bgcolor="#3cb2d0" height="55" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#FFFFFF;font-weight: bold;padding-left: 25px;padding-right: 25px;border-radius:4px;">
                          <singleline label="button">OTP: <?php echo e(@$otp); ?></singleline>
                        </td>
                      </tr>
                    </tbody></table>
                  </td>
...
</div></body></html><?php /**PATH /home/sanixu9b/public_html/app/resources/views/email/forget-password.blade.php ENDPATH**/ ?>