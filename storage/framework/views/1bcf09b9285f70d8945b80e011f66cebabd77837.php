                ...
                <div class="card-body">
                    ...
                    <?php echo Form::open(['method' => 'POST', 'route' => 'admin.site-setting.logo', 'class' => 'form-horizontal','files'=>true]); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('logo') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::file('logo', ['class'=>'dropify','data-default-file'=>@$logo->logo]); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('favicon') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::file('favicon', ['class'=>'dropify','data-default-file'=>@$logo->favicon]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\react\resources\views/admin/setting/site-setting.blade.php ENDPATH**/ ?>